...
try:
    ...
    # triton_python_backend_utils exists only inside Triton Python backend.
    pass
...
class TritonPythonModel:
    ...
    def execute(self, requests) -> "List[List[pb_utils.Tensor]]":
        ...
        for request in requests:
            ...
            # Using padding and truncation, we force the output of tokenizer to be of size 512, the max_length of
            # the intfloat/e5-large-unsupervised tokenizer
